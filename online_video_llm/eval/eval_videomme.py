...
def eval_your_results(
    ...
    # Load your results
    your_results = your_results_path
    ...
    for video_type in video_types:
        ...
        if not skip_missing:
            ...
            print(f"Number of files in {video_type} is {len(your_results_video_type)}.")
...
if __name__ == "__main__":
    ...
    root = args.results_file
    overall = []
    for f in os.listdir(root):
        overall += json.load(open(os.path.join(root, f), 'r'))
